"""
Django settings for craftbasketproject project.
...
SECRET_KEY = 'django-insecure-p78^0rr5y1o3m6&w1s_%at-%lf!8cd$gsjzph-3qoa1*(aes&x'
...
ROOT_URLCONF = 'craftbasketproject.urls'
...
WSGI_APPLICATION = 'craftbasketproject.wsgi.application'
